...
def x402_discovery():
    return jsonify({
        ...
        "version": "2.1",
        "description": "Real-time prediction market signals combining Polymarket, Kalshi, and 40+ sportsbooks. Surfaces market disagreements as arbitrage signals for AI agents.",
        "provider": "Nurse2Web3",
        "url": BASE_URL,
        "discoverable": True,
        "category": "prediction-markets",
        "tags": ["prediction-markets", "polymarket", "kalshi", "sports", "nba", "nfl", "mma", "boxing", "politics", "arbitrage"],
        "endpoints": [
...
def health():
    return jsonify({
        "status": "OK", "service": "EventAlphaOracle", "version": "2.1",
